...
<div class="navbar_create">
        ...
        <div class="sidebar_create">
            <ul class="main-nav-ul">
                ...
                <li><a href="index.php"><i class="fas fa-qrcode"></i>Dashboard</a></li>
                  ...
                  <li class="has-sub"><a href="#"><i class="fas fa-qrcode"></i><span class="after">Buat Akun</span></i></a>

                  <ul class="side_drop">
                    
                        <li><a href="create_guru.php"><i class="fas fa-angle-double-right"></i> Guru</a></li>
                ...
                <li><a href="../index.php" onclick="logout()"><i class="fas fa-power-off"></i>Log Out</a></li>
    ...
    <div class="about">
        <a href="tentang.html" target="_blank">
            <center>
