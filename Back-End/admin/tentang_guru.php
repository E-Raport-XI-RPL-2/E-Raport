...
<head>
    ...
    <link rel="icon" href="../assets/img/logogan.png">
...
<body>
    ...
    <div class="navbar_create">
        ...
        <div class="dropdown">
            <h2>Tentang Akun Guru</h2>
            <span class="drop_tentang_guru"><i class="fas fa-sort-down"></i></span>
                ...
                <li><a href="index.php"><i class="fas fa-qrcode"></i>Dashboard</a></li>
                                ...
                                <li class="has-sub"><a href="tentang.php"><i class="fas fa-address-card"></i><span
                                    ...
                                    <ul class="side_drop">
                                        ...
                                        <li><a href="tentang_guru.php"><i class="fas fa-angle-double-right"></i>Tentang
                                                Akun Guru</a></li>
                                        <li><a href="tentang_wali.php"><i class="fas fa-angle-double-right"></i>Tentang
                                                Akun Wali Kelas</a>
                                        </li>
    ...
    <div class="konten">
        <div class="form-box-tentang">
            <form action="">
                <center>
                    <label for="">Cari Akun Guru</label>
                </center>
                <br>
